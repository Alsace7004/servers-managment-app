  ...
  <div class="sidebar">
    ...
    <ul>
      <div class="conteneur_inner">
        ...
        <li>
          <router-link
            v-if="$can('typeStaff-list')"
            :to="{ name: 'type_de_staff' }"
            class="item"
          >
